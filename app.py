...
# Subplot 1: Believers vs Skeptics
...
# Subplot 3: Cumulative Rewards with 90% Confidence Interval
            ...
            def compute_ci(data):
                ...
                ci = 1.645 * np.array(std_err)  # 90% CI using z = 1.645
                return mean, ci
